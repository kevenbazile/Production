  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
      ...
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-white">Filmmakers Signup Form</h1>
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          Be your own Film Festival! Get paid to share your Vision,  TV shows, and Negotiating deals with agents
          </h2>
          <p className="mt-2 text-sm text-gray-400">Post your short films and TV shows at the click of a button. Cancel anytime.</p>
        </div>
